...
static class VertexTangentsFactory
{
        ...
        where T : IMeshPrimitive
    {
        ...
        var tangentsMap = new Dictionary<ValueTuple<Vector3, Vector3, Vector2>, (Vector3 u, Vector3 v)>();
    ...
    private static void _AddTangent(Dictionary<ValueTuple<Vector3, Vector3, Vector2>, (Vector3, Vector3)> dict, ValueTuple<Vector3, Vector3, Vector2> key, (Vector3 tu, Vector3 tv) alpha)
    {
