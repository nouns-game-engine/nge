    ...
    public abstract class LoaderContext
    {
        ...
        private static IEnumerable<SRCPRIM> _GetValidPrimitives(SRCMESH srcMesh)
        {
            foreach (var srcPrim in srcMesh.Primitives)
            {
                ...
                if (srcPrim.DrawPrimitiveType == SharpGLTF.Schema2.PrimitiveType.POINTS) continue;
                if (srcPrim.DrawPrimitiveType == SharpGLTF.Schema2.PrimitiveType.LINES) continue;
                if (srcPrim.DrawPrimitiveType == SharpGLTF.Schema2.PrimitiveType.LINE_LOOP) continue;
                if (srcPrim.DrawPrimitiveType == SharpGLTF.Schema2.PrimitiveType.LINE_STRIP) continue;
